...
def handle_unconnected_ping(data, server):
...
def handle_unconnected_ping_open_connections(data, server):
...
def handle_open_connection_request_1(data, server):
...
def handle_open_connection_request_2(data, address, server):
